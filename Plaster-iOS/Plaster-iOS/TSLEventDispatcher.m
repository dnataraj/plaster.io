...
@implementation TSLEventDispatcher {
...
- (uint)dispatchTask:(NSString *)taskName WithPeriod:(uint64_t)interval andController:(id)controller {
    ...
    if (timer) {
        ...
        dispatch_source_set_event_handler(timer, ^{
            if ([unretained_cont respondsToSelector:@selector(onTimer)]) {
